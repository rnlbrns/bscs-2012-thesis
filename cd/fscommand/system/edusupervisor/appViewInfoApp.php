...
if(!empty($APP_ID))
{
	...
	echo"<center><form method='POST' action='appViewInfoAction.php'>
	<input type='hidden' value=".$APP_ID." name='APP_ID' />
	";
	echo"<h4>Information for: ".mb_strtoupper($APP_LASTNAME).", ".mb_strtoupper($APP_FIRSTNAME)." ".mb_strtoupper($APP_MIDNAME)."</h4>";
	echo"<table class='tableView' cellspacing=10 border=1>
	...
	<tr><td align='right'>GWA:</td><td align='left'><b>".mb_strtoupper($APP_GWA)."</b></td></tr>
...
<input type='submit' name='fw' value='Confirm for Ranking' />
<input type='submit' name='fw' value='Reject Application' />
