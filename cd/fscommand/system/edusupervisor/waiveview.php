...
$querydueforwaivescholars=mysql_query("select * from beneficiary_tbl a, program_tbl b, hei_tbl c where a.PROG_ID=b.PROG_ID and a.HEI_ID=c.HEI_ID and a.BENEFICIARY_STAT='Recommended for Waive' and a.BENEFICIARY_ID=".$BENEFICIARY_ID);

$disp=mysql_fetch_array($querydueforwaivescholars);
	
echo"
<br /><center>Are you sure you want to waive the scholarship of ".mb_strtoupper($disp["BENEFICIARY_nam3"]).", ".mb_strtoupper($disp["BENEFICIARY_nam1"])." ".mb_strtoupper($disp["BENEFICIARY_nam2"])."?
<br />
