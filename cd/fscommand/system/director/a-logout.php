...
konekServer::abriDB();
	...
	$audittrailquery=mysql_query("insert into audittrail_tbl set audittrail_username='".$_SESSION["directorUsername"]."',  audittrail_activity='Log-Out', audittrail_time=now() ") or die(mysql_error());	
