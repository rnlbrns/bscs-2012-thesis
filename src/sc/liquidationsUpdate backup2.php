...
<br />
<b>Number Of Subject:</b>&nbsp;&nbsp;<input type='text' value='' name='numSub'>
<br />
<br />
<input type='hidden' name='BENEFICIARY_ID' value=".$BENEFICIARY_ID." />
<input type='submit' name='fw' value='Generate Grade Input'>
<input type='button' value='Cancel' onClick='history.back();'>
</form>
...
";
	...
	function gradeMainInput($BENEFICIARY_ID,$schoolyr_yr,$GRADE_SEM,$numSub){
		
		$ihapnumSub=0;
		echo"
		<input type='hidden' name='BENEFICIARY_ID' value=".$BENEFICIARY_ID.">
		<input type='hidden' name='schoolyr_yr' value='".$schoolyr_yr."'>
		<input type='hidden' name='GRADE_SEM' value=".$GRADE_SEM.">
		<input type='hidden' name='numSub' value=".$numSub.">
			<table border=1>
			<tr>
		...
		while($ihapnumSub<$numSub){
			$ihapnumSub++;
			echo"
			<tr>
			<td align='center'><input type='text name='GRADE_SUBJ".$ihapnumSub."' value=''></td>
			<td align='center'><input type='text name='GRADE_UNIT".$ihapnumSub."' value='' style='width:50px'></td>
			<td align='center'><input type='text name='GRADE_GRADE".$ihapnumSub."' value='' style='width:50px'></td>
			<td align='center'>
...
else if ($_POST["fw"]=="Generate Grade Input")
{
	...
	$sulod=new liquidationsUpdate();
	$butang=new paragLayOut();
	$butang->butangSulod($sulod->gradeMainInput($BENEFICIARY_ID,$schoolyr_yr,$GRADE_SEM,$numSub));
